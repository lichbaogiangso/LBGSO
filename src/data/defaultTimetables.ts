...
export const DEFAULT_TEACHERS: TeacherInfo[] = [
  ...
  { id: "thy_mt", name: "Cô Thy", role: "GV Chuyên Mĩ thuật & HĐTN (20 tiết)", type: "specialist", specialistSubject: "Mĩ thuật", assignedClasses: ["1A", "1B", "2A", "2B", "3A", "3B", "4A", "4B", "5A", "5B"], subjects: ["Mĩ thuật", "MT", "HĐTN"], teachingPeriods: 20, totalPeriods: 20 },
  ...
  { id: "nhan_bm", name: "Cô Nhàn", role: "GV Bộ môn (17 tiết)", type: "specialist", specialistSubject: "Đạo đức", assignedClasses: ["1A", "1B", "2A", "2B", "4A", "4B", "5A", "5B"], subjects: ["Đạo đức", "Công nghệ", "TCT", "TCTV", "HĐTN"], teachingPeriods: 17, totalPeriods: 17 },
  ...
  { id: "phuong_th", name: "Cô D.Phương", role: "GV Chuyên Tin học (10 tiết)", type: "specialist", specialistSubject: "Tin học", assignedClasses: ["1A", "1B", "2A", "2B", "3A", "3B", "4A", "4B", "5A", "5B"], subjects: ["Tin học", "TH"], teachingPeriods: 10, totalPeriods: 10 },
  { id: "quan_pht", name: "Phan Ngọc Quan (PHT)", role: "Phó Hiệu trưởng (4 tiết)", type: "specialist", specialistSubject: "Đạo đức", assignedClasses: ["4A", "4B", "5A", "5B"], subjects: ["Đạo đức", "ĐĐ"], teachingPeriods: 4, totalPeriods: 4 },
];
...
export const TIMETABLE_TUAN_2_SLOTS: Record<string, Record<string, string>> = {
  ...
  // THỨ NĂM (17/09/2026)
  "Thứ Năm_Sáng_1": { "1A": "GDTC (Thịnh)", "1B": "TV", "2A": "T", "2B": "TV", "3A": "TV", "3B": "TV", "4A": "TV", "4B": "BDAN (Tâm)", "5A": "TV", "5B": "TV" },
  ...
  "Thứ Năm_Sáng_4": { "1A": "TCT (Phước)", "1B": "AN (Tâm)", "2A": "TV", "2B": "TCTV", "3A": "CN", "3B": "TCT", "4A": "T", "4B": "T", "5A": "TA (Nương)", "5B": "MT (Thy)" },
  "Thứ Năm_Sáng_5": { "1A": "", "1B": "", "2A": "", "2B": "", "3A": "", "3B": "", "4A": "", "4B": "", "5A": "", "5B": "" },
...
export const DEFAULT_MASTER_TIMETABLE: MasterTimetable = {
  ...
  version: "2026_v8_official_tuan2_all_teachers_sync",
